...
import OrderSuccess from "./OrderSuccess"; // ✅ kalau file ada di pages: sesuaikan path
import {
  Trash2,
  Plus,
  ShoppingCart,
...
export default function VideoCall() {
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      // bersihkan cart & munculkan modal sukses
      setCart([]);
      setCreatedOrder(inserted);
      setSuccessOpen(true);

      // optional: toast boleh dihapus kalau gak mau
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Cart */}
            <div className={`bg-[#12161F] rounded-2xl border border-gray-800 top-6 transition-opacity ${!isOpen ? "opacity-60 pointer-events-none select-none" : ""}`}>
              <div className="p-6 border-b border-gray-800">
                                  ...
                                  {item.backup_id === item.member_id &&
                                    ...
                                    item.backup_session === item.session && (
                                      <p className="text-red-400 text-xs mt-1">
                                        ⚠️ Member dan tanggal sama, sesi harus berbeda!
                                      </p>
                                    )}
                                </div>
                              )}
        ...
        {/* ✅ Modal wrapper: isi pakai OrderSuccess, tanpa Order ID */}
        {successOpen && (
